...
try:
    ...
    # Add the API.
    if mod_manager.any_http_endpoints:
        if HTTP_API_ALLOWED:
            ...
            # Check to see if any mods have any http api endpoints defined. If so, show a warning that they
            # won't work and to install the correct dependency.
            for mod in mod_manager.mods.values():
