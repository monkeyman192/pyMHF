...
If you forget to add the ``@property`` decorator on top of the function, the widget will be rendered in the GUI but it will have the value looking something like the string ``<Bound method ...>``.
...
:py:func:`INTEGER(label: str, is_slider: bool = False, **kwargs) <pymhf.gui.decorators.INTEGER>`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
If ``is_slider`` is ``True``, a slider will be used to render the widget instead. The allowed extra argument for this case can be found `here <https://dearpygui.readthedocs.io/en/latest/reference/dearpygui.html#dearpygui.dearpygui.add_slider_int>`__.

:py:func:`FLOAT(label: str, is_slider: bool = False, **kwargs) <pymhf.gui.decorators.FLOAT>`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
If ``is_slider`` is ``True``, a slider will be used to render the widget instead. The allowed extra argument for this case can be found `here <https://dearpygui.readthedocs.io/en/latest/reference/dearpygui.html#dearpygui.dearpygui.add_slider_double>`__.
